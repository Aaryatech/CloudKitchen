...
public class Constants {
	...
	public static final String url = "http://15.207.112.119:8080/ckwebapi/";

	// -----------------------------------------------------------------

	// public static final String imageShowUrl =
	// "https://107.180.91.43:8080/uploads/ckuploads/";
	...
	public static final String cashSecretKey = "44bb412ea48da2acb093573debfdd42306099612";
	public static final String cashFreeOrderCreateLink = "https://api.cashfree.com/";

	// test credential
	/*
	 * public static final String cashFreeAppId = "2800447959f7f92f77608613b40082";
	 * public static final String cashSecretKey =
	 * "7baef9681dc8696e0b4ceeb150e4fb05962fdbe3"; public static final String
	 * cashFreeOrderCreateLink= "https://test.cashfree.com/";
	 */
