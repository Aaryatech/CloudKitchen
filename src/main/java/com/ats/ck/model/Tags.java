...
public class Tags {
	...
	public String toString() {
		return "Tags [tagId=" + tagId + ", tagName=" + tagName + ", tagDesc=" + tagDesc + ", tagIsActive=" + tagIsActive
				+ ", tagDeleteStatus=" + tagDeleteStatus + ", tagSortNumber=" + tagSortNumber + ", exInt1=" + exInt1
