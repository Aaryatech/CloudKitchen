						...
						<div class="login-sec">
							<div class="login-box">
								<form
									...
									<h4 class="text-light-black fw-600 signin_title">Enter OTP</h4>
									<div class="row">
										<div class="col-12">
											...
											<input type="hidden" id="mob" name="mob" value="${contact}">
												...
												<label class="text-light-white fs-14">
													</label> <input type="text" name="otp"
